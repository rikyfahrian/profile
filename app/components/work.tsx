...
export function Work() {
  return (
    <section className="grid gap-12 md:grid-cols-2 max-w-4xl mx-auto items-center self-center mt-10">
      <div>
        <h2 className="text-xl font-semibold mb-4">Work Experience</h2>
        <div className="flex gap-2">
          <Link href={"https://www.dynamics-ms.com/"} target="_blank" className="hidden sm:block">
