    ...
    <main className="min-h-screen max-w-4xl mx-auto px-6 py-8">
      ...
      <section className="mt-10">
        <p className="text-lg sm:text-2xl  text-justify">
          I love skateboarding, but I have noticed one recurring problem: almost every beginner gets
          their setup wrong. Whether its the wrong deck size, mismatched truck width, wheels that
          dont suit their style, or even buying poor-quality boards—it happens constantly. Maybe
          they dont have experienced friends to ask, or they are too shy to reach out. Its not their
          fault; the information out there is scattered and confusing. Thats why I built this. Its a
          simple, clean space where beginners can finally understand their gear, make the right
          choices, and focus on what truly matters: learning to skate better.
        </p>
      </section>
